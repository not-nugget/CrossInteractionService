...
namespace CrossInteractionService.Service
{
    ...
    {
        private readonly SortedDictionary<Type, object> services;
        ...
        public DependencyProvider(IServiceProvider rootProvider, SortedDictionary<Type, object> services) : this(rootProvider)
        {
    ...
    {
        private readonly SortedDictionary<Type, object> services = new();
